...
function add_frontend_viewer(){
	...
	if(is_user_logged_in()){ ?>
		...
		<span id="acfv-toggle" class="acfv-btn <?php if(is_admin_bar_showing()){ echo 'adminbar-visible';} ?>">
			<svg class="acfv-btn-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="864px" height="864px" viewBox="28.749 -42.001 864 864" enable-background="new 28.749 -42.001 864 864" xml:space="preserve">
	    		...
	    		<tr>
	    			<td class="acfv-btn-col">
						...
						<div class="acfv-footer">
							<a href="<?php echo admin_url('admin.php?page=advanced-custom-fields-viewer/admin/options.php'); ?>" class="acfv-link">
